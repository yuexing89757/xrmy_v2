...
import com.pzoom.ads.platform.mail.biz.EmailTaskBiz;
import com.pzoom.ads.platform.mail.dao.EmailTaskDao;
import com.pzoom.ads.platform.mail.dao.MailUserInfoDao;
import com.pzoom.ads.platform.mail.dao.ToMailInfoDao;
import com.pzoom.ads.platform.mail.dao.impl.EmailTaskDaoImpl;
import com.pzoom.ads.platform.mail.dao.impl.MailUserInfoDaoImpl;
import com.pzoom.ads.platform.mail.dao.impl.ToMailInfoDaoImpl;
...
import com.pzoom.ads.platform.mail.type.MailType;
import com.pzoom.ads.platform.mail.type.StatusType;
import com.pzoom.ads.platform.mail.util.ErrorBundler;
	...
	public Result<Boolean> addEmailTask(String[] toMail, String title, String mailConent,
	   ...
	   try {
		      ...
		      if(StringUtils.hasLength(planTime)){
			   ...
			   toMailInfo.setSendTime(new Date());
				...
				try {
					...
					errorBundler.setErrorInfo(result, LanguageKey.NETWORK_ANOMALIES);
				} finally {
					transaction.close();
				}
		   ...
		   result.setData(false);
			...
			result.setData(false);
			log.error(e);
			this.errorBundler.setErrorInfo(result, LanguageKey.NETWORK_ANOMALIES);
		}
		return result;
	}
