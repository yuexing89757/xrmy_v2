package com.pzoom.ads.platform.mail.dao.hibernate.util;
...
import com.pzoom.ads.platform.backend.dao.config.HibernateManager;
import com.pzoom.ads.platform.backend.i18n.report.LanguageKey;
	 ...
	 implements GenericDAO<T, ID>
{
	...
	private static Log log = Log.getLogger(GenericHibernateDAO.class.getName());
